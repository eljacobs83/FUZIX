 ...
 *	MC68681 
 *
 *	On this board OP0/1 are RTSA/B and IP0/1 are CTSA/B
 *	IP3-IP5 are used as switches to select the boot baud rate (the other switches
 *	connect to PC0-PC4 on the PI/T). The DUART is clocked at the usual 3.684MHz
 *
 *	TODO: RTS/CTS
 */
...
#define UART_CSRB	0x14
#define UART_CRB	0x16
...
static volatile uint8_t *uart_base = (volatile uint8_t *)0xFF800;
