/*
 *	8x8 bitmap font for the PicoCalc LCD console (printable ASCII 0x20..0x7F).
 *
 *	Each glyph is 8 bytes, top row first; bit 0x80 is the leftmost pixel
 *	(matches the shift loop in devlcd.c plot_char()). This is a compact,
...
const uint8_t fontdata8x8[96 * 8] = {
